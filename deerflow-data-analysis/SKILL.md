---
name: data-analysis
description: Use this skill when the user uploads Excel (.xlsx/.xls) or CSV files and wants to perform data analysis, generate statistics, create summaries, pivot tables, SQL queries, or any form of structured data exploration. Supports multi-sheet Excel workbooks, aggregation, filtering, joins, and exporting results to CSV/JSON/Markdown. NOT for producing or editing a spreadsheet file as the deliverable (adding columns, formulas, formatting, charts) — use xlsx for that; this skill is read-only analytical exploration.
---
